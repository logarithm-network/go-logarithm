...
# 1. install gxlg for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gxlg
# 5. create gxlg, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable LOGARITHM_SOCKET
...
!define GROUPNAME "Logarithm"
!define APPNAME "Gxlg"
!define DESCRIPTION "Official Go implementation of the Logarithm protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gxlg is installed global
