...
var (
	...
	authorsFileHeader = "# This is the official list of go-logarithm authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-logarithm Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-logarithm library"
	}
	return "the go-logarithm library"
}
