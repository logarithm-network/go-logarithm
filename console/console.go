...
import (
	...
	"github.com/logarithm-network/go-logarithm/internal/jsre"
	"github.com/logarithm-network/go-logarithm/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Logarithm requests through
...
// Welcome show summary of current Gxlg instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gxlg metadata
	fmt.Fprintf(c.printer, "Welcome to the Gxlg JavaScript console!\n\n")
	c.jsre.Run(`
