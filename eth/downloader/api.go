...
// Syncing provides information when this nodes starts synchronising with the Logarithm network and when it's finished.
...
type SyncingResult struct {
	...
	Status  logarithm.SyncProgress `json:"status"`
}
