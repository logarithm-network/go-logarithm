...
// Package bind generates Logarithm contract Go bindings.
//
// Detailed usage document and tutorial available on the go-logarithm Wiki page:
// https://github.com/logarithm-network/go-logarithm/wiki/Native-DApps:-Go-bindings-to-Logarithm-contracts
package bind
