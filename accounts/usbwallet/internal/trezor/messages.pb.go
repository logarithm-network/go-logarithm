...
const (
	...
	MessageType_MessageType_LogarithmGetAddress       MessageType = 56
	MessageType_MessageType_LogarithmAddress          MessageType = 57
	MessageType_MessageType_LogarithmSignTx           MessageType = 58
	MessageType_MessageType_LogarithmTxRequest        MessageType = 59
	MessageType_MessageType_LogarithmTxAck            MessageType = 60
	...
	MessageType_MessageType_LogarithmSignMessage      MessageType = 64
	MessageType_MessageType_LogarithmVerifyMessage    MessageType = 65
	MessageType_MessageType_LogarithmMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_LogarithmGetAddress",
	57:  "MessageType_LogarithmAddress",
	58:  "MessageType_LogarithmSignTx",
	59:  "MessageType_LogarithmTxRequest",
	60:  "MessageType_LogarithmTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_LogarithmSignMessage",
	65:  "MessageType_LogarithmVerifyMessage",
	66:  "MessageType_LogarithmMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_LogarithmGetAddress":       56,
	"MessageType_LogarithmAddress":          57,
	"MessageType_LogarithmSignTx":           58,
	"MessageType_LogarithmTxRequest":        59,
	"MessageType_LogarithmTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_LogarithmSignMessage":      64,
	"MessageType_LogarithmVerifyMessage":    65,
	"MessageType_LogarithmMessageSignature": 66,
...
// *
// Request: Ask device for Logarithm address corresponding to address_n path
// @next PassphraseRequest
// @next LogarithmAddress
// @next Failure
type LogarithmGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *LogarithmGetAddress) Reset()                    { *m = LogarithmGetAddress{} }
func (m *LogarithmGetAddress) String() string            { return proto.CompactTextString(m) }
func (*LogarithmGetAddress) ProtoMessage()               {}
func (*LogarithmGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *LogarithmGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *LogarithmGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Logarithm address derived from device private seed
// @prev LogarithmGetAddress
type LogarithmAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *LogarithmAddress) Reset()                    { *m = LogarithmAddress{} }
func (m *LogarithmAddress) String() string            { return proto.CompactTextString(m) }
func (*LogarithmAddress) ProtoMessage()               {}
func (*LogarithmAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *LogarithmAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next LogarithmTxRequest
// @next Failure
type LogarithmSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *LogarithmSignTx) Reset()                    { *m = LogarithmSignTx{} }
func (m *LogarithmSignTx) String() string            { return proto.CompactTextString(m) }
func (*LogarithmSignTx) ProtoMessage()               {}
func (*LogarithmSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *LogarithmSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *LogarithmSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *LogarithmSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *LogarithmSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *LogarithmSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *LogarithmSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *LogarithmSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *LogarithmSignTx) GetDataLength() uint32 {
...
func (m *LogarithmSignTx) GetChainId() uint32 {
...
// @prev LogarithmSignTx
// @next LogarithmTxAck
type LogarithmTxRequest struct {
...
func (m *LogarithmTxRequest) Reset()                    { *m = LogarithmTxRequest{} }
func (m *LogarithmTxRequest) String() string            { return proto.CompactTextString(m) }
func (*LogarithmTxRequest) ProtoMessage()               {}
func (*LogarithmTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *LogarithmTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *LogarithmTxRequest) GetSignatureV() uint32 {
...
func (m *LogarithmTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *LogarithmTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev LogarithmTxRequest
// @next LogarithmTxRequest
type LogarithmTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *LogarithmTxAck) Reset()                    { *m = LogarithmTxAck{} }
func (m *LogarithmTxAck) String() string            { return proto.CompactTextString(m) }
func (*LogarithmTxAck) ProtoMessage()               {}
func (*LogarithmTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *LogarithmTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next LogarithmMessageSignature
// @next Failure
type LogarithmSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *LogarithmSignMessage) Reset()                    { *m = LogarithmSignMessage{} }
func (m *LogarithmSignMessage) String() string            { return proto.CompactTextString(m) }
func (*LogarithmSignMessage) ProtoMessage()               {}
func (*LogarithmSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *LogarithmSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *LogarithmSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type LogarithmVerifyMessage struct {
...
func (m *LogarithmVerifyMessage) Reset()                    { *m = LogarithmVerifyMessage{} }
func (m *LogarithmVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*LogarithmVerifyMessage) ProtoMessage()               {}
func (*LogarithmVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *LogarithmVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *LogarithmVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *LogarithmVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev LogarithmSignMessage
type LogarithmMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *LogarithmMessageSignature) Reset()                    { *m = LogarithmMessageSignature{} }
func (m *LogarithmMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*LogarithmMessageSignature) ProtoMessage()               {}
func (*LogarithmMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *LogarithmMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *LogarithmMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*LogarithmGetAddress)(nil), "LogarithmGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*LogarithmAddress)(nil), "LogarithmAddress")
	...
	proto.RegisterType((*LogarithmSignTx)(nil), "LogarithmSignTx")
	proto.RegisterType((*LogarithmTxRequest)(nil), "LogarithmTxRequest")
	proto.RegisterType((*LogarithmTxAck)(nil), "LogarithmTxAck")
	proto.RegisterType((*LogarithmSignMessage)(nil), "LogarithmSignMessage")
	proto.RegisterType((*LogarithmVerifyMessage)(nil), "LogarithmVerifyMessage")
	proto.RegisterType((*LogarithmMessageSignature)(nil), "LogarithmMessageSignature")
