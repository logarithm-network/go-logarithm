...
// Package types contains data types related to Logarithm consensus.
package types
...
// Header represents a block header in the Logarithm blockchain.
type Header struct {
...
// Block represents an entire block in the Logarithm blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Logarithm
...
// EncodeRLP serializes b into the Logarithm RLP block format.
