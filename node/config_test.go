...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gxlg.ipc", false, filepath.Join(os.TempDir(), "gxlg.ipc")},
		{"data", "gxlg.ipc", false, "data/gxlg.ipc"},
		{"data", "./gxlg.ipc", false, "./gxlg.ipc"},
		{"data", "/gxlg.ipc", false, "/gxlg.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gxlg.ipc", true, `\\.\pipe\gxlg.ipc`},
		{"data", "gxlg.ipc", true, `\\.\pipe\gxlg.ipc`},
		{"data", `\\.\pipe\gxlg.ipc`, true, `\\.\pipe\gxlg.ipc`},
	}
