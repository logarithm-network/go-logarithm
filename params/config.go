...
var (
	MainnetGenesisHash = common.HexToHash("0xd2d35673c7480c14ee698b1f2beb2c2b2b37d5ed6ff222069dbfc0d857ca7294") // Mainnet genesis hash to enforce below configs on
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		ChainId:        big.NewInt(301333),
		HomesteadBlock: big.NewInt(0),
		DAOForkBlock:   nil, // Important to pass DAO fork check
		DAOForkSupport: true,
	...
	// and accepted by the Logarithm core developers into the Ethash consensus.
	//
	...
	// and accepted by the Logarithm core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
