...
import (
	...
	"github.com/logarithm-network/go-logarithm/crypto/ecies"
	"github.com/logarithm-network/go-logarithm/event/filter"
...
// Whisper represents a dark communication interface through the Logarithm
...
// New creates a Whisper client ready to communicate through the Logarithm P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
