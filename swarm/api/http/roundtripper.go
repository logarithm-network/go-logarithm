...
see https://github.com/logarithm-network/go-logarithm/issues/2040
Usage:

import (
 "github.com/logarithm-network/go-logarithm/common/httpclient"
 "github.com/logarithm-network/go-logarithm/swarm/api/http"
)
