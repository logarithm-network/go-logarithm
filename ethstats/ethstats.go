...
// Service implements an Logarithm netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Logarithm      // Full Logarithm service if monitoring a full node
	les    *les.LightLogarithm // Light Logarithm service if monitoring a light node
...
func New(url string, ethServ *eth.Logarithm, lesServ *les.LightLogarithm) (*Service, error) {
