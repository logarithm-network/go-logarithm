...
// Contains a wrapper for the Logarithm client.
...
import (
	...
	"github.com/logarithm-network/go-logarithm/ethclient"
)

// LogarithmClient provides access to the Logarithm APIs.
type LogarithmClient struct {
	client *ethclient.Client
}

// NewLogarithmClient connects a client to the given URL.
func NewLogarithmClient(rawurl string) (client *LogarithmClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &LogarithmClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *LogarithmClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *LogarithmClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *LogarithmClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *LogarithmClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *LogarithmClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *LogarithmClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *LogarithmClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *LogarithmClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *LogarithmClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *LogarithmClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *LogarithmClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *LogarithmClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *LogarithmClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *LogarithmClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *LogarithmClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *LogarithmClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *LogarithmClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *LogarithmClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *LogarithmClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *LogarithmClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *LogarithmClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *LogarithmClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *LogarithmClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *LogarithmClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *LogarithmClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *LogarithmClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *LogarithmClient) SendTransaction(ctx *Context, tx *Transaction) error {
