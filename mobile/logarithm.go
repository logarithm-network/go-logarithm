...
// Contains all the wrappers from the go-logarithm root package.
...
// the Logarithm network.
type SyncProgress struct {
	progress logarithm.SyncProgress
}
