...
// setting up a new or managing an existing Logarithm private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Logarithm private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Logarithm network down to  |")
	...
	log.Info("Administering Logarithm network", "name", w.network)
