...
type wizard struct {
	...
	services map[string][]string   // Logarithm services known to be running on servers
...
// converts it to an Logarithm address. If an empty line is entered, the default
// value is returned.
