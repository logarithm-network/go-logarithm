...
import (
	...
	"github.com/logarithm-network/go-logarithm/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Logarithm contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Logarithm contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Logarithm contract Solidity source to build and bind")
